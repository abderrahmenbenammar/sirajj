            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200/60 dark:border-gray-800/60 p-6 sm:p-8">
              ...
              {course.curriculum.length === 0 ? (
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  {t("لا توجد دروس في هذه الدورة بعد. تفقد الدورة لاحقًا.", "No lessons in this course yet. Check back later.")}
                </p>
              ) : (
                ...
                {course.curriculum.map((item, i) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <span className="block text-sm font-medium text-gray-900 dark:text-white group-hover:text-emerald-700 dark:group-hover:text-emerald-400 transition-colors truncate">
